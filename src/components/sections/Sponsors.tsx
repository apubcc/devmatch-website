  ...
  const tiers = [
    {
      ...
      sponsors: [
        { name: 'TBC', logo: '', width: 180 },
        { name: 'TBC', logo: '', width: 180 },
        { name: 'TBC', logo: '', width: 180 },
      ]
    },
    {
      name: 'Stellar Sponsors',
      sponsors: [
        { name: 'TBC', logo: '', width: 150 },
        { name: 'TBC', logo: '', width: 150 },
        { name: 'TBC', logo: '', width: 150 },
      ]
    },
    {
      name: 'Cosmic Contributors',
      sponsors: [
        { name: 'TBC', logo: '', width: 120 },
        { name: 'TBC', logo: '', width: 120 },
        { name: 'TBC', logo: '', width: 120 },
    ...
    <section id="sponsors" className="section-container bg-space-light/30">
      ...
      {tiers.map((tier, tierIndex) => (
        <div key={tierIndex} className="mb-16 last:mb-0">
          ...
          <div 
            className={`grid grid-cols-2 md:grid-cols-${Math.min(tier.sponsors.length, 4)} gap-8 justify-items-center`}
          >
            {tier.sponsors.map((sponsor, sponsorIndex) => (
              <div 
                key={sponsorIndex} 
                className="flex gem-card p-6 flex-col items-center justify-center group"
