...
const Sponsors: React.FC = () => {
  const sponsors = [
    ...
    { name: 'Blockchain for Good Alliance (BGA)', logo: '/BGA-Logo.png', width: 180 },
    { name: 'The Graph', logo: '/the-graph-grt-logo.png', width: 180 }
  ];

  const mediaPartners = [
    { name: 'GDG USM', logo: '/logo_media/GDG USM logo (centered) - Chi San.png' },
    { name: 'AIC', logo: '/logo_media/WhatsApp Image 2025-06-01 at 11.53.31 PM - Amlan Gupta.jpeg' },
    { name: 'Sunway Blockchain Club', logo: '/logo_media/Full_Logo_Black - Sunway Blockchain Club.png' },
    { name: 'Agents of Tech', logo: '/logo_media/Agents of Tech Logo - Yu En Liew.png' },
    { name: 'UBA', logo: '/logo_media/UBA-Logo - Hariz Hakim.png' },
    { name: 'IT Society MMU', logo: '/logo_media/IT_Society_MMU_logo - asmaa noli.png' },
    { name: 'APU Hackthletes', logo: '/logo_media/APUHackthletes Logo Transparent (For Black Background) - Ee Hann Choong.png' },
    { name: 'CS Society USM', logo: '/logo_media/CS Official Logo - Padma Pireeyaa.png' },
    { name: 'Monash Blockchain', logo: '/logo_media/monash_blockchain - Derek Goh.png' },
    { name: 'FSEC APU', logo: '/logo_media/FSEC LOGO transparent bg - cheryl woo.png' }
  ];
  ...
  <h3 className="text-2xl font-orbitron font-bold mb-6 text-center">Media Partners</h3>
    ...
    {mediaPartners.map((partner, index) => (
      ...
      <div className="mt-20">
        ...
        <div className="flex justify-center">
          <a href="mailto:info@apubcc.org" className="btn-secondary">
